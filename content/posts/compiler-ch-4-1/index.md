...
- 推导方式：
    ...
    - 跳步骤、连续推导的符号：$\Rightarrow^*$
      ![400](../../../_GeneralResources/Pasted%20image%2020250309100640.png)
...
- ![500](../../../_GeneralResources/Pasted%20image%2020250309101319.png)


- 最右推导 $\Rightarrow_{rm}$ 类似喵

### Parse Trees / Syntax Trees 语法树
- ![](../../../_GeneralResources/Pasted%20image%2020250309102414.png)
...
- Ambiguity 描述了 CFG 的一种性质：如果 CFG 构成的 CGL 中的一个字符串可以有多个不同的语法树，那么这个 CFG 是有二义性的；如果 CFL 的所有字符串都有唯一树的与之对应，那这个 CFG 就没有二义性。
  ![](../../../_GeneralResources/Pasted%20image%2020250309103137.png)
...
提高某些运算符的优先级，先推导它们。
- ![600](../../../_GeneralResources/Pasted%20image%2020250309105306.png)

##### 2. 重写文法

比如 `if-else` 的二义性
- ![600](../../../_GeneralResources/Pasted%20image%2020250309105559.png)
- ![400](../../../_GeneralResources/Pasted%20image%2020250309105625.png)
...
![600](../../../_GeneralResources/Pasted%20image%2020250309110423.png)
...
- ![600](../../../_GeneralResources/Pasted%20image%2020250309111807.png)
...
- ![600](../../../_GeneralResources/Pasted%20image%2020250309123551.png)
- ![](../../../_GeneralResources/Pasted%20image%2020250309123631.png)
...
例子：
- ![1000](../../../_GeneralResources/Pasted%20image%2020250309164507.png)

### DPDA: Deterministic PDA

在任何时刻，对于给定的输入符号或栈顶符号（这俩任意一个一样都不行），最多只有一个转移动作。

- ![](../../../_GeneralResources/Pasted%20image%2020250309164929.png)
...
1. $L_1 \cup L_2$
   ![](../../../_GeneralResources/Pasted%20image%2020250309165419.png)
2. $L_1L_2$
   ![](../../../_GeneralResources/Pasted%20image%2020250309165449.png)
3. $L^*_1$
   ![](../../../_GeneralResources/Pasted%20image%2020250309165518.png)
4. $L_1^R$
   ![](../../../_GeneralResources/Pasted%20image%2020250309165611.png)
...
-  ![800](../../../_GeneralResources/Pasted%20image%2020250309171905.png)
> 为什么 $a^nb^n$ 是 CFL? 因为能把他构造成一个很基础的 PDA.

- ![800](../../../_GeneralResources/Pasted%20image%2020250309172448.png)
